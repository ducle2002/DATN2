        ...
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            ...
            return new[]
            {
               ...
               // new SettingDefinition(AppSettings.TenantManagement.UserBillConfig.SendUserBillNotificationDay, ConfigurationManager.AppSettings[AppSettings.TenantManagement.UserBillConfig.SendUserBillNotificationDay] ?? "1", scopes: SettingScopes.Tenant),
                ...
                //Reflect config
                new SettingDefinition(AppSettings.TenantManagement.ReflectConfig.AddWork, ConfigurationManager.AppSettings[AppSettings.TenantManagement.ReflectConfig.AddWork] ?? "false", scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.TenantManagement.ReflectConfig.AddHandler, ConfigurationManager.AppSettings[AppSettings.TenantManagement.ReflectConfig.AddHandler] ?? "false", scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.TenantManagement.ReflectConfig.DisableOrganizationUnit, ConfigurationManager.AppSettings[AppSettings.TenantManagement.ReflectConfig.DisableOrganizationUnit] ?? "false", scopes: SettingScopes.Tenant),
