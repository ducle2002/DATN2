...
namespace Yootek.Authorization
{
    public static class IOCPermissionNames
    {
        ...
        public const string Pages_Government_Hotline = "Pages.Government.Hotline";
        ...
        public const string Pages_Revenue_And_Expenditure_Management = "Pages.Revenue.And.Expenditure.Management";
    }
}