...
namespace Yootek.Authorization.Users
{
    public class UserManager : AbpUserManager<Role, User>
    {
        ...
        private readonly IRepository<OrganizationStructureUnit, long> _departmentRepository;
        ...
        public UserManager(
            ...
            IRepository<OrganizationStructureUnit, long> departmentRepository,
        ...
        #region Department
        public async Task<OrganizationStructureUnit> GetDepartmentByIdAsync(long id, int? tenantId)
        {
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                using (_unitOfWorkManager.Current.SetTenantId(tenantId))
                {
                    return await _departmentRepository.FirstOrDefaultAsync(id);
                }
            });
        ...
        #endregion
        #region Organization
        public async Task<AppOrganizationUnit> GetOrganizationUnitByIdAsync(long id, int? tenantId)
        {
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                using(_unitOfWorkManager.Current.SetTenantId(tenantId))
                {
                    return await _organizationUnitRepository.FirstOrDefaultAsync(id);
                }
            });
