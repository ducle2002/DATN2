...
namespace Yootek.App.ServiceHttpClient.Yootek.SmartCommunity
{
    public interface IHttpWorkAssignmentService
    {
        ...
        Task<MicroserviceResultDto<WorkPlanByOrganizationDto>> GetWorkPlanByOrganization( GetWorkPlanByOrganizationInputDto input);
        Task<MicroserviceResultDto<List<WorkPlanByUserDto>>> GetWorkPlanByUser(GetWorkPlanByUserInputDto input);
        ...
        Task<MicroserviceResultDto<UserWorkDetailDto>> UserGetWorkDetailDaily(UserGetWorkDetailDailyDto input);
        Task<MicroserviceResultDto<long?>> UserCheckWorkDaily(UserCheckWorkDailyDto input);
        Task<MicroserviceResultDto<long?>> CreateWorkFromUserReflect([FromBody] CreateWorkFromUserReflectDto input);
    ...
    public class HttpWorkAssignmentService : IHttpWorkAssignmentService
    {
        ...
        public async Task<MicroserviceResultDto<WorkPlanByOrganizationDto>> GetWorkPlanByOrganization(GetWorkPlanByOrganizationInputDto input)
        {
            var query = "api/v1/work/get-work-plan-by-organization" + input.GetStringQueryUri();
            using var request = new HttpRequestMessage(HttpMethod.Get, query);

            request.HandleGet(_session);
            var response = await _client.SendAsync(request);
            return await response.ReadContentAs<MicroserviceResultDto<WorkPlanByOrganizationDto>>();
        }

        public async Task<MicroserviceResultDto<List<WorkPlanByUserDto>>> GetWorkPlanByUser(GetWorkPlanByUserInputDto input)
        {
            var query = "api/v1/work/get-work-plan-by-user" + input.GetStringQueryUri();
            using var request = new HttpRequestMessage(HttpMethod.Get, query);

            request.HandleGet(_session);
            var response = await _client.SendAsync(request);
            return await response.ReadContentAs<MicroserviceResultDto<List<WorkPlanByUserDto>>>();
        }
        ...
        public async Task<MicroserviceResultDto<UserWorkDetailDto>> UserGetWorkDetailDaily(UserGetWorkDetailDailyDto input)
        {
            input.WorkDay = input.WorkDay.ToUniversalTime();
            var query = $"api/v1/work/user-get-work-detail-daily?id={input.Id}&workDay={input.WorkDay.ToString("yyyy-MM-dd")}";
            using var request = new HttpRequestMessage(HttpMethod.Get, query);

            request.HandleGet(_session);
            var response = await _client.SendAsync(request);
            return await response.ReadContentAs<MicroserviceResultDto<UserWorkDetailDto>>();
        }
        public async Task<MicroserviceResultDto<long?>> UserCheckWorkDaily(UserCheckWorkDailyDto input)
        {
            using (var request = new HttpRequestMessage(HttpMethod.Post, $"/api/v1/work/user-check-work-daily"))
            {
        ...
        public async Task<MicroserviceResultDto<long?>> CreateWorkFromUserReflect([FromBody] CreateWorkFromUserReflectDto input)
        {
            using (var request = new HttpRequestMessage(HttpMethod.Post, $"/api/v1/work/create-work-from-reflect"))
            {
                request.HandlePostAsJson(input, _session);
                var response = await _client.SendAsync(request);
                var result = await response.ReadContentAs<MicroserviceResultDto<long?>>();
