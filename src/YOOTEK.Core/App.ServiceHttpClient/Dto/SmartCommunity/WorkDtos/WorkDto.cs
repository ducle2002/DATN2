...
namespace Yootek.App.ServiceHttpClient.Dto.Yootek.SmartCommunity.WorkDtos
{
    ...
    public class WorkDto
    {
        ...
        public int CountLogTimeGood { get; set; }
        public int CountLogTimeNotGood { get; set; }
    }
    ...
    public class UserWorkDetailDto
    {
        ...
        public int TypeStructure { get; set; }
        public long? UrbanId { get; set; }
        public long? BuildingId { get; set; }
        public long? OrganizationUnitId { get; set; }
        public List<string>? ImageUrls { get; set; }
        ...
        public List<long>? RecipientIds { get; set; }
        public List<long>? SupervisorIds { get; set; }
        public List<UserWorkLogTimeDto>? WorkLogTimes { get; set; }
        public List<UserWorkLogTimeDto>? WorkLogTimeWeeks { get; set; }
        public List<UserWorkLogTimeDto>? WorkLogTimeMonths { get; set; }
        public List<UserWorkLogTimeDto>? WorkLogTimeYears { get; set; }
    ...
    public class UserWorkLogTimeDto : Entity<long>
    {
        public int? TenantId { get; set; }
        public long WorkId { get; set; }
        public string? WorkName { get; set; }
        public string? WorkDetailName { get; set; }
    ...
    public class GetWorkPlanByOrganizationInputDto
    {
        public long OrganizationUnitId { get; set; }
        public TypeStructure TypeStructure { get; set; }
    }

    public class ExportWorkPlanByOrganizationInputDto
    {
        public long OrganizationUnitId { get; set; }
        public TypeStructure TypeStructure { get; set; }
    ...
    public class GetWorkPlanByUserInputDto
    {
       public long? UserId { get; set; }
    }

    public class ExportWorkPlanByUserInputDto
    {
        public DateTime Month { get; set; }
        public long? UserId { get; set; }
    }
    ...
    public class UserGetWorkDetailDailyDto
    {
        public long Id { get; set; }
    ...
    public class CreateWorkFromUserReflectDto
    {
    ...
    public class UserCheckWorkDailyDto
    {
        public long WorkId { get; set; }
        public List<WorkLogtimeCheckDto> Logtimes { get; set; }
    }

    public class WorkLogtimeCheckDto
    {
        public long Id { get; set; }
        public int? QualityWork { get; set; }
    }
    ...
    public class WorkPlanDetailDto : EntityDto<long>
    {
        ...
        public EWorkStatus Status { get; set; }
        public long WorkTypeId { get; set; }
        [MaxLength(512)] public string? QrCode { get; set; }
        public int? TenantId { get; set; }
        public int Type { get; set; }
        public TypeStructure TypeStructure { get; set; }
        public long? UrbanId { get; set; }
    ...
    public class WorkPlanByOrganizationDto
    {
        public long OrganizationUnitId { get; set; }
        public string OrganizationName { get;set; }
        public TypeStructure TypeStructure { get; set; }
        public List<WorkPlanDetailDto> WorkPlans { get; set; }

    }

    [AutoMap(typeof(WorkPlanDetailDto))]
    public class WorkPlanByUserDto : EntityDto<long>
    {
        [MaxLength(512)] public string Title { get; set; }
        [MaxLength(2000)] public string? Content { get; set; }
        public List<string>? ImageUrls { get; set; }
