...
namespace Yootek.Services
{
    ...
    public class GetAllNhatKyVanHanhInputDto : CommonInputDto
    {
        ...
        public DateTime? NgaySuaChuaFrom { get; set; }
        public DateTime? NgaySuaChuaTo { get; set; }
        public DateTime? NgayCheckListFrom { get; set; }
        public DateTime? NgayCheckListTo { get; set; }
    }
