...
namespace Yootek.Services
{
    ...
    public class StatisticBillAppService : YootekAppServiceBase, IStatisticBillAppService
    {
        ...
        private readonly IRepository<ApartmentStatus, long> _apartmentStatusRepository;
        ...
        public StatisticBillAppService(
            ...
            IRepository<ApartmentStatus, long> apartmentStatusRepository,
            ...
            )
        {
            ...
            _apartmentStatusRepository = apartmentStatusRepository;
        ...
        public async Task<object> ExportAllDetailUserBillToExcel(GetAllBillsByMonthDto input)
        {
            try
            {
                ...
                List<ApartmentDetailtDto> apartments = (from apt in _apartmentRepository.GetAll()
                                                        ...
                                                        join aps in _apartmentStatusRepository.GetAll() on apt.StatusId equals aps.Id into tb_aps
                                                        from aps in tb_aps.DefaultIfEmpty()
                                                        ...
                                                        select new ApartmentDetailtDto()
                                                        {
                                                            ...
                                                            UrbanId = apt.UrbanId,
                                                            ApartmentTypeName = aptt.Name, // New field
                                                            ApartmentStatusName = aps.Name, // New field
    ...
    .ToList();
                ...
                foreach (var apartment in apartments)
                {
                    var detail = new ApartmentPaymentBillDetailDto()
                    {
                        ...
                        ApartmentStatusName = apartment.ApartmentStatusName,
